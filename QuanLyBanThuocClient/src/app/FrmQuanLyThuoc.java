...
public class FrmQuanLyThuoc extends JPanel implements ActionListener, MouseListener, ItemListener {
	...
	public FrmQuanLyThuoc() throws MalformedURLException, RemoteException, NotBoundException {
		initialize(fMain);
	}
	...
	private void initialize(JFrame fMain) throws MalformedURLException, RemoteException, NotBoundException {
		...
		JLabel lblEmployeeManagement = new JLabel("QUAN LY THUOC");
